...
4. The workflow file lives at `infra/ci/github-actions.yaml`; pushes to `main` (and tags/branches) will build and push images. Pull requests build only (no push).
